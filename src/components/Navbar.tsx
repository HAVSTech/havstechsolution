...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full border-b border-white/10 bg-[#07111f]/85 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <a href="#home" className="flex items-center" aria-label="HAVS Tech Solutions home">
          <img src={havsLogo} alt="HAVS Tech Solutions" className="h-12 w-auto brightness-0 invert" />
        </a>
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-slate-950 transition-all hover:bg-blue-50 hover:shadow-lg hover:shadow-blue-500/20"
          >
