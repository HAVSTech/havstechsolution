    ...
    <section id="services" className="relative overflow-hidden bg-slate-50 py-24 sm:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <p className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-blue-600">Our solutions</p>
          <h2 className="text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">One technology partner for your next stage of growth.</h2>
              ...
              <Card key={service.number} className="group relative overflow-hidden rounded-3xl border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-900/5">
                <CardHeader className="pb-3">
                  <div className="mb-8 flex items-start justify-between">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 transition-colors group-hover:bg-blue-600 group-hover:text-white"><Icon className="h-6 w-6" /></div>
                ...
                <CardContent>
                  ...
                  {service.href ? (
                    <a href={service.href} className="mt-7 inline-flex items-center gap-1 text-sm font-semibold text-blue-600">Explore solution <ArrowUpRight className="h-4 w-4" /></a>
                  ) : (
                    <a href="#contact" className="mt-7 inline-flex items-center gap-1 text-sm font-semibold text-blue-600">Discuss capability <ArrowUpRight className="h-4 w-4" /></a>
                  )}
                </CardContent>
              </Card>
            );
        ...
        <div className="mt-16 overflow-hidden rounded-[2rem] bg-[#07111f] p-8 text-white sm:p-10 lg:flex lg:items-center lg:justify-between">
          ...
          <a href="#contact" className="mt-7 inline-flex shrink-0 items-center gap-2 rounded-full bg-white px-6 py-3 font-semibold text-slate-950 transition hover:bg-blue-50 lg:mt-0">Start with a discovery call <ArrowUpRight className="h-4 w-4" /></a>
        </div>
      </div>
    </section>
  );
